...
public interface RecyclerBindingPort {
    ...
    /**
     * 确保绑定钩子已安装；对应注入侧Recycler绑定Hook安装幂等语义。
     * 空参由实现方忽略，不抛给宿主。
     */
