...
public final class RuleServiceContractTest {
    ...
    public void mutationAndLeaseContractsHaveSingleCanonicalValues() {
        ...
        assertEquals(8, RuleServiceContract.RESULT_STALE);
        assertEquals(9, RuleServiceContract.RESULT_EXPIRED);
        assertEquals(10, RuleServiceContract.RESULT_OWNER_MISMATCH);
        assertEquals(11, RuleServiceContract.RESULT_ALREADY_UNDONE);
